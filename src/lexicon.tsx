        ...
        items: [
            {
                ...
                description_ja: "様々な熟した果実が組み合わさった甘く、フローラルな風味。"
            },
            {
                name: "berry",
                ...
                description_ja: "ブラックベリー、ラズベリー、ブルーベリー、ストロベリーなど、さまざまなベリーから連想される、甘酸っぱく、フローラルで、ときに重厚な風味。",
                item: [
                    {
                        name: "strawberry",
                        ...
                        description_ja: "ストロベリーから連想される、やや甘く、やや酸味があり、フローラルで、フルーティで、しばしばワインのような風味。",
                    },
                    {
                        name: "raspberry",
                        ...
                        description_ja: "ラズベリーから連想される、ほのかな甘み、フルーティー、フローラル、ほのかな酸味とカビっぽい風味。"
                    },
                    {
                        name: "blueberry",
                        ...
                        description_ja: "ブルーベリーから連想される、やや濃く、フルーティーで、甘く、やや酸っぱく、かび臭く、ほこりっぽく、花のような風味。"
                    },
                    {
                        name: "blackberry",
                        ...
                        description_ja: "ブラックベリーから連想される、甘く、濃く、フルーティーで、フローラルで、少し酸味があり、ややウッディな風味。"
                    },
                ]
            },
            {
                ...
                description_ja: "ドライプラムやレーズンを連想させる、甘くほのかに褐色がかった濃い果実の風味。",
                items: [
                    {
                        name: "raisin",
                        ...
                        description_ja: "干しブドウ特有の、濃縮された、甘く、やや酸味のある、褐色の、フルーティーで花のような風味。"
                    },
                    {
                        name: "prune",
                        ...
                        description_ja: "甘く、わずかに褐色で、フローラルで、かび臭く、熟しすぎた風味の印象は、干しプラムを連想させるダークフルーツ。"
                    },
                ]
            },
            {
                ...
                items: [
                    {
                        ...
                        description_ja: "甘く、軽く、フルーティーで、ややフローラルな風味で、新鮮なリンゴや加工されたリンゴによく使われる。"
                    },
                    {
                        name: "pear",
                        displayName_en: "Pear",
                        ...
                        description_ja: "甘く、ほのかにフローラルで、カビ臭く、ウッディで、フルーティな洋梨の風味。"
                    },
                    {
                        name: "peach",
                        ...
                        description_ja: "フローラルで、風味があり、フルーティーで、甘く、ほのかに酸味のある桃の風味。"
                    },
                    {
                        name: "grape",
                        ...
                        description_ja: "甘く、フルーティーで、花のようで、少し酸味があり、かび臭い、一般的にブドウに関連する風味。"
                    },
                    {
                        name: "cherry",
                        ...
                        description_ja: "サクランボから連想される酸味、フルーティーさ、ほのかな苦味、花のような風味。"
                    },
                    {
                        name: "pomegrante",
                        ...
                        description_ja: "酸味があり、甘いフルーティーな風味で、やや暗く、カビ臭く、土っぽさがあり、ダークフルーツやビーツやニンジンなどの根菜を連想させる。"
                    },
                    {
                        name: "coconut",
                        ...
                        description_ja: "ココナッツから連想される、ほんのり甘く、ナッツのような、ややウッディな風味。"
                    },
                    {
                        name: "pineapple",
                        ...
                        description_ja: "パイナップルから連想される、甘く、ややシャープで、フルーティーな風味。"
                    },
                    {
                        name: "citrus fruit",
                        ...
                        description_ja: "レモン、ライム、グレープフルーツ、オレンジなどを含む、クエン酸、酸味、渋み、ほのかな甘み、すっぱさ、ややフローラルな風味。",
                        items: [
                            {
                                name: "lemon",
                                ...
                                description_ja: "レモンから連想される、クエン酸、酸味、渋み、ほのかな甘み、小便のような、やや花のような風味。"
                            },
                            {
                                name: "grapefruit",
                                ...
                                description_ja: "グレープフルーツから連想される、クエン酸、酸味、苦味、渋み、豆っぽさ、シャープさ、ほのかに甘い風味。"
                            },
                            {
                                name: "orange",
                                ...
                                description_ja: "オレンジから連想される、柑橘系の、甘く、フローラルで、わずかに酸っぱい風味。"
                            },
                            {
                                name: "lime",
                                displayName_en: "Lime",
                                ...
                                description_ja: "ライムから連想されるクエン酸、酸味、渋味、苦味、青臭さ、鋭さ、そしてややフローラルな風味。"
                            },
                        ],
                    }
                ]
        ...
        items: [
            {
                ...
                description_ja: "酸っぱい製品の印象を連想させる風味。",
            },
            {
                name: "acetic acid",
                ...
                description_ja: "酢を連想させる酸味、渋み、わずかに刺激的な風味。",
            },
            {
                name: "butyric acid",
                ...
                description_ja: "パルメザンのような特定の熟成チーズに関連する、酸味のある発酵乳製品の風味。",
            },
            {
                ...
                description_ja: "刺激的な酸味のある風味で、汗臭い足の臭いや、ロマーノなどの特定の熟成チーズを連想させる。",
            },
            {
                name: "citric acid",
                ...
                description_ja: "マイルドでクリーン、酸味のある風味で、わずかに柑橘系の香りと渋みを伴う。",
            },
            {
                name: "malic acid",
                ...
                description_ja: "酸味があり、シャープでややフルーティーな風味。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "蒸留酒や穀物製品に含まれる、無色で刺激的な化学薬品のような風味。",
            },
            {
                name: "whiskey",
                ...
                description_ja: "発酵させた穀物のマッシュから蒸留された製品に付随する風味。",
            },
            {
                name: "winey",
                ...
                description_ja: "ワインから連想される、鋭く、刺激的で、ややフルーティーな、アルコールのような風味。",
            },
            {
                name: "fermented",
                ...
                description_ja: "発酵した果実や砂糖、または過醗酵の生地に特有の、刺激的で、甘く、わずかに酸っぱく、時にはイーストのような、アルコールのような風味。",
            },
            {
                ...
                description_ja: "完熟を過ぎた果物や野菜に特有の、甘く、わずかに酸っぱく、湿った、かび臭い、土臭い風味。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "軽くオイリーな風味で、バター、グリーン、ペッパー、ビター、甘い香りがある。",
            },
            {
                name: "raw",
                displayName_en: "Raw",
            ...
            },
            {
                ...
                description_ja: "緑色や未熟な果実に含まれる風味。",
            },
            {
                name: "peapod",
                ...
                description_ja: "グリーンの風味で、甘く、ビーニーで、フレッシュで、生臭く、カビっぽい。",
            },
            {
                name: "green",
                ...
                description_ja: "新鮮な植物由来の素材に特徴的な風味。葉のような、ブドウのような、未熟な、草のような、豆のようななどの特徴がある。",
            },
            {
                name: "fresh",
                ...
                description_ja: "刈りたての草や葉の多い植物を連想させるグリーンな風味で、甘く刺激的な特徴がある。",
            },
            {
                name: "dark green",
                ...
                description_ja: "ホウレンソウ、ケール、インゲン豆などの調理された緑黄色野菜によく含まれる風味で、苦味、甘味、ほこりっぽさ、かびっぽさ、土っぽさなどの要素を含み、濃く重い印象を与えることがある。",
            },
            {
                name: "vegetative",
                ...
                description_ja: "パセリ、ホウレンソウ、ピーポッドなど、緑色の植物や野菜から連想される、シャープでやや刺激的な風味。",
            },
            {
                name: "hay-like",
                ...
                description_ja: "ほのかに甘く、ドライでほこりっぽい風味で、乾燥した牧草を思わせるわずかなグリーンの特徴がある。",
            },
            {
                name: "herb-like",
                ...
                description_ja: "一般的にグリーンハーブに関連する風味で、甘く、わずかに辛く、わずかに苦いのが特徴。緑色や茶色の香りを含む場合もあれば、含まない場合もある。",
            },
            {
                name: "beany",
                ...
                description_ja: "豆や豆製品に特徴的な風味で、カビ臭さ、土臭さ、酸味のある風味、苦味のある風味、デンプン質、緑色／豆粒色、ナッツ色、褐色の要素を含む。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "フレッシュさに欠けるのが特徴の風味。",
            },
            {
                name: "papery",
                ...
                description_ja: "白い紙コップから連想される風味。",
            },
            {
                name: "cardboard",
                ...
                description_ja: "段ボールや紙の包装に付随する風味。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "木の樹皮から連想される、甘く、褐色で、かび臭く、濃い風味。",
            },
            {
                name: "musty/earthy",
                ...
                description_ja: "朽ち果てた植物や湿った黒土を連想させる、やや甘く重厚な風味。",
            },
            {
                name: "musty/dusty",
                ...
                description_ja: "屋根裏部屋やクローゼットなど、乾燥した密閉空間に関連する風味。乾燥した、かび臭い、紙のような、乾いた土、穀物などの要素を持つことがある。",
            },
            {
                name: "moldy/damp",
                ...
                description_ja: "湿った閉鎖空間や地下室を連想させる風味。かび臭く、鋭く、わずかに青臭い。",
            },
            {
                name: "phenolic",
            ...
            },
            {
                ...
                description_ja: "農耕動物や生きた動物の棲息に関連する風味の組み合わせ。",
            },
            {
                name: "meaty/brothy",
                ...
                description_ja: "茹でた肉、スープ、ストックを連想させる風味で、弱い肉の香りがある。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "バンドエイド、アルコール、ヨードなどの防腐剤に似た製品に特有の、清潔で無菌的な風味。",
            },
            {
                name: "rubber",
                ...
                description_ja: "ゴムを連想させる、濃く、重く、やや鋭く、刺激的な風味。",
            },
            {
                name: "petroleum",
                ...
                description_ja: "原油およびその精製品に含まれる特定の化学風味族で、重質油の性質を持つ。",
            },
            {
                name: "skunky",
                ...
                description_ja: "スカンクから連想される風味の組み合わせ。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "褐色で、わずかに甘く、わずかに刺激的な、熟成したタバコに関連する風味。",
            },
            {
                name: "pipe tobacco",
                ...
                description_ja: "褐色で、甘く、わずかに刺激的で、フルーティー、フローラル、スパイシーな風味。",
            },
            {
                name: "acrid",
                ...
                description_ja: "乾燥した、埃っぽい、汚れた、スモーキーな風味は、焦げた製品の残留物に関連している。",
            },
            {
                name: "ashy",
                displayName_en: "Ashy",
            ...
            },
            {
                ...
                description_ja: "鋭敏で刺激的な風味で、木材、葉、または非天然物の燃焼生成物である。",
            },
            {
                name: "roasted",
        ...
        items: [
            {
                ...
                description_ja: "穀物から連想される薄茶色で埃っぽく、かび臭く、甘い風味。",
            },
            {
                name: "malt",
                displayName_en: "Malt",
                ...
                description_ja: "穀物に付随する、薄茶色で、ほこりっぽく、かび臭く、甘く、酸っぱく、またはわずかに発酵した風味。",
            },
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "挽いた黒胡椒に特徴的な、スパイシーで刺激的、かび臭く、ウッディな風味。",
            },
            {
                name: "anise",
                ...
                description_ja: "刺激的で甘く、褐色でキャラメルのような風味。",
            },
            {
                name: "nutmeg",
                ...
                description_ja: "ウェットで褐色、ウッディで刺激的、石油のような重厚な風味。",
            },
            {
                name: "brown spice",
                ...
                description_ja: "シナモン、クローブ、ナツメグ、オールスパイスなどのスパイスを連想させる甘く褐色の風味。",
            },
            {
                name: "cinnamon",
                ...
                description_ja: "甘く、褐色で、わずかにウッディー、わずかに刺激的でスパイシーな風味。",
            },
            {
                name: "clove",
                ...
                description_ja: "甘く、褐色で、スパイシーで、刺激的で、フローラルで、柑橘系で、薬効があり、わずかにミントのような風味。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "ナッツ類、種子類、豆類、穀類によく含まれる、やや甘く、褐色、木質、油性、かび臭い、渋味、苦味のある風味。",
            },
            {
                name: "almond",
                ...
                description_ja: "ローズ、チェリー、アプリコットなどのフローラルでフルーティーな香りを持つ、甘くライトブラウンのウッディでバターのような風味。渋みがあり、わずかにスモーキーな香りもある。",
            },
            {
                name: "hazelnut",
                ...
                description_ja: "ウッディで、褐色、甘く、カビ臭く、耳ざわりで、わずかに杉の風味。フローラル、ビーニー、オイリー、アストリンゼント、ビターな香りを含むこともある。",
            },
            {
                name: "peanuts",
                ...
                description_ja: "甘く、淡褐色、オイリーで、ややカビ臭く、ほこりっぽい風味。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "ココアバターとダークローストの風味を含むカカオのブレンド。",
            },
            {
                name: "cocoa",
                displayName_en: "Cocoa",
                ...
                description_ja: "カカオ豆、ココアパウダー、チョコレートバーなどに含まれる、褐色で、甘く、ほこりっぽく、かび臭く、しばしば苦い風味。",
            },
            {
                name: "dark chocolate",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "メイプルシロップを連想させる、ウッディで、甘く、キャラメルのような、褐色で、わずかにグリーンな風味。",
            },
            {
                name: "brown sugar",
                ...
                description_ja: "リッチでコクがあり、まろやかで甘い印象の風味。",
            },
            {
                name: "caramelized",
                ...
                description_ja: "まろやかでフルボディ、ミディアムブラウンの甘い風味。焦げたような香りはない。",
            },
            {
                name: "honey",
                ...
                description_ja: "蜂蜜を連想させる、甘く、薄茶色で、わずかにスパイシーな風味。",
            },
            {
                name: "vanilla",
                ...
                description_ja: "バニラビーンズを連想させる、ウッディでややケミカルな風味で、ブラウン、ビーニー、フローラル、スパイシーな香りを含むこともある。",
            },
            {
                name: "vanillin",
                ...
                description_ja: "バニラ、コットンキャンディー、マシュマロを連想させる、非常に甘く、非天然の風味。",
            },
            {
        ...
        items: [
            {
                ...
                description_ja: "新鮮な花を連想させる、甘く、軽く、ほのかに香る風味。",
            },
            {
                name: "rose",
                displayName_en: "Rose",
            ...
            },
            {
                ...
                description_ja: "力強く、わずかに刺激的で、甘く、フローラルな風味。",
            },
            {
                name: "chamomile",
            ...
            },
            {
                ...
                description_ja: "やや褐色でかび臭い、茶葉の酸化に伴う乾燥植物と乾燥樹皮の風味。",
            },
        ]
    },
    {
