        ...
        items: [
            {
                ...
                description_ja: "ショ糖が代表的な味覚の基本要素。"
            },
            {
                name: "sour",
                displayName_en: "Sour",
                ...
                description_ja: "クエン酸水溶液に関連する基本的な味の要素。"
            },
            {
                name: "bitter",
                ...
                description_ja: "カフェイン水溶液に関連する基本的な味の要素。"
            },
            {
                name: "salty",
                ...
                description_ja: "塩化ナトリウムを代表とする基本的な味の要素。"
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "様々な熟した果実の甘く、フローラルでアロマティックなブレンド。"
            },
            {
                name: "berry",
                displayName: "Berry",
                ...
                description_ja: "ブラックベリー、ラズベリー、ブルーベリー、ストロベリーなど、さまざまなベリーから連想される、甘酸っぱく、フローラルで、ときに重厚な芳香。",
                item: [
                    {
                        name: "strawberry",
                        displayName: "Strawberry",
                        description_en: "The somewhat sweet, slightly sour, floral, fruity, frequently winey aromatic associated with strawberry.",
                        description_ja: "ストロベリーから連想される、やや甘く、やや酸味があり、フローラルで、フルーティで、しばしばワインのような芳香。",
                    },
                    {
                        name: "raspberry",
                        ...
                        description_ja: "ラズベリーから連想される、ほのかな甘み、フルーティー、フローラル、ほのかな酸味とカビっぽい芳香。"
                    },
                    {
                        name: "blueberry",
                        displayName: "Blueberry",
                        description_en: "The slightly dark, fruity, sweet, slightly sour, musty, dusty, floral aromatic associated with blueberry.",
                        description_ja: "ブルーベリーから連想される、やや濃く、フルーティーで、甘く、やや酸っぱく、かび臭く、ほこりっぽく、花のような芳香。"
                    },
                    {
                        name: "blackberry",
                        ...
                        description_ja: "ブラックベリーから連想される、甘く、濃く、フルーティーで、フローラルで、少し酸味があり、ややウッディなアロマ。"
                    },
                ]
            },
            {
                ...
                description_ja: "ドライプラムやレーズンを連想させる、甘くほのかに褐色がかった濃い果実のアロマ。",
                items: [
                    {
                        name: "raisin",
                        displayName: "Raisin",
                        description_en: "The concentrated, sweet, somewhat sour, brown, fruity, floral aromatic characteristic of dried grapes.",
                        description_ja: "干しブドウ特有の、濃縮された、甘く、やや酸味のある、褐色の、フルーティーで花のような芳香。"
                    },
                    {
                        name: "prune",
                        displayName: "Prune",
                        ...
                        description_ja: "甘く、わずかに褐色で、フローラルで、かび臭く、熟しすぎたアロマの印象は、干しプラムを連想させるダークフルーツ。"
                    },
                ]
            },
            {
                name: "other fruit",
                displayName: "Other Fruit",
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        description_ja: "酸味があり、甘いフルーティーなアロマで、やや暗く、カビ臭く、土っぽさがあり、ダークフルーツやビーツやニンジンなどの根菜を連想させる。"
                    },
                    {
                        name: "coconut",
                        displayName: "Coconut",
                        description_en: "The slightly sweet, nutty, somewhat woody aromatic associated with coconut.",
                        description_ja: "ココナッツから連想される、ほんのり甘く、ナッツのような、ややウッディなアロマ。"
                    },
                    {
                        name: "pineapple",
                        displayName: "Pineapple",
                        description_en: "The sweet, slightly sharp, fruity aromatic associated with pineapple.",
                        description_ja: "パイナップルから連想される、甘く、ややシャープで、フルーティーな芳香。"
                    },
                    {
                        name: "citrus fruit",
                        ...
                        description_ja: "レモン、ライム、グレープフルーツ、オレンジなどを含む、クエン酸、酸味、渋み、ほのかな甘み、すっぱさ、ややフローラルなアロマティック。",
                        items: [
                            {
                                name: "lemon",
                                displayName: "Lemon",
                                description_en: "The citric, sour, astringent, slightly sweet, peely and somewhat floral aromatic associated with lemon.",
                                description_ja: "レモンから連想される、クエン酸、酸味、渋み、ほのかな甘み、小便のような、やや花のような芳香。"
                            },
                            {
                                name: "grapefruit",
                                ...
                                description_ja: "グレープフルーツから連想される、クエン酸、酸味、苦味、渋み、豆っぽさ、シャープさ、ほのかに甘い芳香。"
                            },
                            {
                                name: "orange",
                                displayName: "Orange",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "発酵した果実や砂糖、または過醗酵の生地に特有の、刺激的で、甘く、わずかに酸っぱく、時にはイーストのような、アルコールのような芳香。",
            },
            {
                name: "overripe/near fermented",
                displayName: "Overripe/Near Fermented",
                ...
                description_ja: "完熟を過ぎた果物や野菜に特有の、甘く、わずかに酸っぱく、湿った、かび臭い、土臭い芳香。",
            },
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "新鮮な植物由来の素材に特徴的な芳香。葉のような、ブドウのような、未熟な、草のような、豆のようななどの特徴がある。",
            },
            {
                name: "fresh",
                displayName: "Fresh",
                ...
                description_ja: "刈りたての草や葉の多い植物を連想させるグリーン・アロマティックで、甘く刺激的な特徴がある。",
            },
            {
                name: "dark green",
                ...
                description_ja: "ホウレンソウ、ケール、インゲン豆などの調理された緑黄色野菜によく含まれる芳香で、苦味、甘味、ほこりっぽさ、かびっぽさ、土っぽさなどの要素を含み、濃く重い印象を与えることがある。",
            },
            {
                name: "vegetative",
                ...
                description_ja: "パセリ、ホウレンソウ、ピーポッドなど、緑色の植物や野菜から連想される、シャープでやや刺激的な芳香。",
            },
            {
                name: "hay-like",
                displayName: "Hay-like",
                description_en: "The lightly sweet, dry, dusty aromatic with slight green character associated with dry grasses.",
                description_ja: "ほのかに甘く、ドライでほこりっぽいアロマティックで、乾燥した牧草を思わせるわずかなグリーンの特徴がある。",
            },
            {
                name: "herb-like",
                displayName: "Herb-like",
                ...
                description_ja: "一般的にグリーンハーブに関連する芳香で、甘く、わずかに辛く、わずかに苦いのが特徴。緑色や茶色の香りを含む場合もあれば、含まない場合もある。",
            },
            {
                name: "beany",
                displayName: "Beany",
                ...
                description_ja: "豆や豆製品に特徴的な芳香で、カビ臭さ、土臭さ、酸味のある芳香、苦味のある芳香、デンプン質、緑色／豆粒色、ナッツ色、褐色の要素を含む。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "フレッシュさに欠けるのが特徴のアロマティック。",
            },
            {
                name: "papery",
                ...
                description_ja: "白い紙コップから連想される芳香。",
            },
            {
                name: "cardboard",
                ...
                description_ja: "段ボールや紙の包装に付随する芳香。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "木の樹皮から連想される、甘く、褐色で、かび臭く、濃い芳香。",
            },
            {
                name: "musty/earthy",
                displayName: "Musty/Earthy",
                description_en: "The somewhat sweet, heavy aromatic associated with decaying vegetation and damp, black soil.",
                description_ja: "朽ち果てた植物や湿った黒土を連想させる、やや甘く重厚なアロマ。",
            },
            {
                name: "musty/dusty",
                displayName: "Musty/Dusty",
        ...
        items: [
            {
                ...
                description_ja: "バンドエイド、アルコール、ヨードなどの防腐剤に似た製品に特有の、清潔で無菌的な芳香。",
            },
            {
                name: "rubber",
                displayName: "Rubber",
                description_en: "A dark, heavy, slightly sharp, and pungent aromatic associated with rubber.",
                description_ja: "ゴムを連想させる、濃く、重く、やや鋭く、刺激的な芳香。",
            },
            {
                name: "petroleum",
                ...
                description_ja: "原油およびその精製品に含まれる特定の化学芳香族で、重質油の性質を持つ。",
            },
            {
                name: "skunky",
                displayName: "Skunky",
                description_en: "A combination of aromatics associated with skunks.",
                description_ja: "スカンクから連想される芳香の組み合わせ。",
            },
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "乾熱によって高温に調理された製品に特徴的な暗褐色の印象。苦味や焦げを含まない。",
            },
            {
                name: "brown, roast",
                displayName: "Brown, Roast",
                ...
                description_ja: "芳醇で丸みのある香りの印象は、常にある程度の暗さを特徴とし、一般的にトースト、ナッツ、ロースト、甘いなどの属性と関連する。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "ナッツ類、種子類、豆類、穀類によく含まれる、やや甘く、褐色、木質、油性、かび臭い、渋味、苦味のある芳香。",
            },
            {
                name: "almond",
                displayName: "Almond",
                ...
                description_ja: "ローズ、チェリー、アプリコットなどのフローラルでフルーティーな香りを持つ、甘くライトブラウンのウッディでバターのようなアロマティック。渋みがあり、わずかにスモーキーな香りもある。",
            },
            {
                name: "hazelnut",
                ...
                description_ja: "ウッディで、褐色、甘く、カビ臭く、耳ざわりで、わずかに杉のアロマティック。フローラル、ビーニー、オイリー、アストリンゼント、ビターな香りを含むこともある。",
            },
            {
                name: "peanuts",
                displayName: "Peanuts",
                description_en: "A sweet, light brown, oily, somewhat musty/dusty, beany aromatic that may be slightly astringent",
                description_ja: "甘く、淡褐色、オイリーで、ややカビ臭く、ほこりっぽいアロマティック。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "ココアバターとダークローストのアロマを含むカカオのブレンド。",
            },
            {
                name: "cocoa",
                displayName: "Cocoa",
                ...
                description_ja: "カカオ豆、ココアパウダー、チョコレートバーなどに含まれる、褐色で、甘く、ほこりっぽく、かび臭く、しばしば苦いアロマ。",
            },
            {
                name: "dark chocolate",
                ...
                description_ja: "カカオとココアバターの強度の高いブレンドで、ダークロースト、スパイシー、焦げたような、かび臭い香りを含み、渋みと苦味が増している。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "濃いカラメルのようなトップノートは、糖蜜特有のややシャープで刺激的な硫黄の香りを含むことがある。",
            },
            {
                name: "maple syrup",
                ...
                description_ja: "メイプルシロップを連想させる、ウッディで、甘く、キャラメルのような、褐色で、わずかにグリーンなアロマ。",
            },
            {
                name: "brown sugar",
                ...
                description_ja: "リッチでコクがあり、まろやかで甘いアロマティックな印象。",
            },
            {
                name: "caramelized",
                displayName: "Caramelized",
                ...
                description_ja: "まろやかでフルボディ、ミディアムブラウンの甘いアロマ。焦げたような香りはない。",
            },
            {
                name: "honey",
                displayName: "Honey",
                description_en: "Sweet, light brown, slightly spicy aromatic associated with honey.",
                description_ja: "蜂蜜を連想させる、甘く、薄茶色で、わずかにスパイシーなアロマ。",
            },
            {
                name: "vanilla",
                displayName: "Vanilla",
                ...
                description_ja: "バニラビーンズを連想させる、ウッディでややケミカルなアロマで、ブラウン、ビーニー、フローラル、スパイシーな香りを含むこともある。",
            },
            {
                name: "vanillin",
                ...
                description_ja: "バニラ、コットンキャンディー、マシュマロを連想させる、非常に甘く、非天然のアロマティック。",
            },
            {
                name: "sweet aromatics",
                displayName: "Sweet Aromatics",
                description_en: "An aromatic associated with the impression of a sweet substance.",
                description_ja: "甘い物質を連想させる芳香剤。",
            },
            {
                name: "overall sweet",
                displayName: "Overall Sweet",
                description_en: "The perception of a combination of sweet taste and aromatics.",
                description_ja: "甘味と芳香の組み合わせの知覚。",
            },
        ],
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "やや褐色でかび臭い、茶葉の酸化に伴う乾燥植物と乾燥樹皮の芳香。",
            },
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description_ja: "完全で統合された感覚体験が口の中で持続し、飲み込んだ後に持続する時間。",
            },
            {
                name: "fullness",
                ...
                description_ja: "製品に厚みを与えるフレーバーノートの土台。丸みを帯びたしっかりとした味わい。",
            },
        ]
    },
    {
        ...
        items: [
            {
                ...
                description_ja: "舌の表面および/または口の端が乾燥したり、ひりひりしたり、ピリピリしたりする感覚。",
            },
            {
                name: "thickness",
                ...
                description_ja: "舌を通すと、飲み物のとろりとした感触がある。",
            },
            {
                name: "metalic",
                ...
                description_ja: "ブリキ缶やアルミホイルを連想させる香りと口当たり。",
            },
            {
                name: "oily",
                displayName_en: "Oily",
                ...
                description_ja: "嚥下または排痰後に口腔表面に残る脂肪・油膜の量。",
            },
        ]
    }
];